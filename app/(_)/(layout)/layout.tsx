...
export default function RootLayout({
  ...
  return (
    ...
    <SidebarInset suppressHydrationWarning className=" overflow-hidden h-lvh">
      ...
      <div className="flex flex-1 flex-col gap-4 w-full md:p-6 pt-0 h-full overflow-x-hidden overflow-y-hidden">
